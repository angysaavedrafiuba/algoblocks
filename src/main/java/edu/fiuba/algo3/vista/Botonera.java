...
public class Botonera extends HBox {
    ...
    Botonera(Rectangle2D screenBounds, Scene scene, PanelAlgoritmo panel){
        super();
        ...
        BotonGuardarAlgoritmo botonGuardar = new BotonGuardarAlgoritmo(screenBounds, scene, PROPORCION, panel);
